...
PG_KEYWORD("authid", AUTHID, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("connect_by_root", CONNECT_BY_ROOT, RESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("elsif", ELSIF, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("exception", EXCEPTION, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("loop", LOOP, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("minus", MINUS, RESERVED_KEYWORD, AS_LABEL)
...
PG_KEYWORD("nocycle", NOCYCLE, RESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("number", NUMBER, COL_NAME_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("percent", PERCENT_P, RESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("prior", PRIOR, RESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("record", RECORD, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("rowtype", ROWTYPE_P, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("sys_connect_by_path", SYS_CONNECT_BY_PATH, COL_NAME_KEYWORD, BARE_LABEL)
PG_KEYWORD("sysdate", SYSDATE, TYPE_FUNC_NAME_KEYWORD, BARE_LABEL)
PG_KEYWORD("sysid", SYSID, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("system", SYSTEM_P, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("systimestamp", SYSTIMESTAMP, TYPE_FUNC_NAME_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("while", WHILE, UNRESERVED_KEYWORD, BARE_LABEL)
